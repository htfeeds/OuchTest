...
{
    /// <summary>
    /// A class that finds types needed by Ouch by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IOuchFileProvider _fileProvider;
        ...
        public AppDomainTypeFinder(IOuchFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Ouch.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Ouch should iterate assemblies in the app domain when loading Ouch types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Ouch assemblies aren't investigated (e.g. by not including something like "^Ouch|..." you may break core functionality.</remarks>
